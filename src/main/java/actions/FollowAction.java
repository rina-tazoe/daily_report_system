...
public class FollowAction extends ActionBase {
    ...
    public void follow() throws ServletException, IOException {
        ...
        System.out.println("folId"+getRequestParam(AttributeConst.FOL_ID));
        //follow_idを条件に従業員データを取得する
        EmployeeView ev = empService.findOne(toNumber(getRequestParam(AttributeConst.FOL_ID)));
        //セッションからログイン中の従業員情報を取得
